...
public class Emprestimo {
	...
	public String toString() {
		if (dataQueDevolveu == null) {
			return "Emprestimo |" + iD + "| Usuario=" + user.getNome() + ", item=" + item.getNome() + ", dataQueLocou="
					+ dataQueLocou;
		}else {
			return "Emprestimo |" + iD + "| Usuario = " + user.getNome() + ", item = " + item.getNome() + ", Data Que Locou = "
					+ dataQueLocou + "Data que devolveu = "+ dataQueDevolveu;
		}
	}

	public void setDataQueDevolveu(Date data) {
		this.dataQueDevolveu = data;
